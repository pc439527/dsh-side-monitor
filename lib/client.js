...
window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    var exports = module.exports;
        ...
        var LANG_ZH = "zh-CN";
        var LANG_EN = "en-US";
        var MESSAGES = {"zh-CN":{"monitorTitle":"系统监控","live":"实时","refreshNow":"立即刷新","more":"更多","close":"关闭","dragResize":"拖动调整宽度","clickViewSources":"点击查看采集来源","refreshFailed":"数据刷新失败 · 最后成功更新 {ago}","waitingFirstData":"等待首次数据…","sampling":"正在采样…","dataInterrupted":"数据中断 · 最后成功更新 {ago}","viewSuffix":"视角","copyDiagnostics":"复制诊断信息","viewDataSources":"查看采集来源","about":"关于","language":"语言","settingsV03":"设置 (v0.3)","settingsInV03":"设置将在 v0.3 提供","loading":"加载中…","cannotFetch":"无法获取数据：","unknownError":"未知错误","updatedJustNow":"刚刚更新","secondsAgo":"{sec} 秒前","minutesAgo":"{n} 分前","hoursAgo":"{n} 时前","connectionUnavailable":"连接服务不可用","overview":"概览","processes":"进程","docker":"Docker","cpuUsage":"CPU 使用率","memoryUsage":"内存使用率","network":"网络","download":"下行","upload":"上行","disk":"磁盘","noDiskInfo":"无法获取磁盘信息","systemLoad":"系统负载","uptime":"运行时间","systemInfo":"系统信息","operatingSystem":"操作系统","kernel":"内核","hostname":"主机名","physicalCores":"物理核心","logicalCpu":"逻辑 CPU","architecture":"架构","totalMemory":"总内存","diskPartitions":"磁盘分区","networkInterfaces":"网络接口","dockerContainers":"Docker 容器","total":"总数","running":"运行","issues":"异常","all":"全部","primary":"主","virtual":"虚拟","iface":"接口","receive":"接收","send":"发送","coresThreadsLoad":"{phys} 核 / {logical} 线程 · Load {load}","logicalCpuLoad":"{logical} 逻辑 CPU · Load {load}","uptimeFull":"{d} 天 {hh} 时 {mm} 分","uptimeHm":"{hh} 时 {mm} 分","uptimeMs":"{mm} 分 {ss} 秒","uptimeS":"{s} 秒","dataSourceHost":"宿主数据","dataSourceContainer":"容器数据","runtimeContainer":"DSH 运行于容器","runtimeHost":"DSH 运行于宿主机","dockerUnavailable":"Docker 不可用","dockerUnavailableSock":"Docker 不可用（未检测到 /var/run/docker.sock）","dockerSockMissing":"未检测到 /var/run/docker.sock","sourcePrefix":"来源：","host":"宿主机","currentContainer":"当前容器","unknown":"未知","searchProcess":"搜索进程 / 命令 / 用户…","mem":"内存","name":"名称","list":"列表","grouped":"聚合","processesTotal":"共 {total} 个进程","matchedSuffix":" · 匹配 {matched} 个","matchedCount":"匹配 {matched} 个","groupsTotalMatched":"共 {total} 类 · 匹配 {matched} 个","byAggregatedCpu":"按聚合 CPU 排序","loadMore":"加载更多","process":"进程","user":"用户","command":"命令","commandPrefix":"命令：","uptimeLabel":"运行时长","groupsCount":"{count} 个进程","searchContainer":"搜索容器 / 镜像 / 端口…","container":"容器","status":"状态","memory":"内存","ports":"端口","noPortMappings":"无端口映射","hostOnly":"仅宿主机","notPublished":"未发布","containerOnly":"容器内","copiedAddr":"已复制地址","copyFailed":"复制失败","notPublishedToast":"未发布到宿主机，仅容器内可用","hostLocalToast":"仅宿主机本地可用","titleUnpublished":"未发布到宿主机（仅容器内端口），不可打开","titleHostLocal":"仅宿主机本地（{host}:{port}），浏览器无法从外部打开","tooltipPort":"宿主 {host}:{port} · 容器端口 {cport}/{proto}","showingContainers":"显示 {count} 个容器","httpOpen":"HTTP 打开","httpsOpen":"HTTPS 打开","copyAddress":"复制地址","copyAddressHostLocal":"复制地址（宿主机本地）","runningState":"运行中","pausedState":"已暂停","stoppedState":"已停止","healthy":"健康","unhealthy":"异常","starting":"启动中","upFor":"已运行 {n} {unit}","unitSeconds":"秒","unitMinutes":"分钟","unitHours":"小时","unitDays":"天","exitedState":"已退出","createdState":"已创建","restartingState":"重启中","dataSources":"采集来源","runtime":"运行环境","loadUptime":"负载 / 运行时长","cpuCoresModel":"CPU 核心 / 型号","kernelVersion":"内核版本","consistencyCheck":"⚠ 一致性自检","unavailable":"不可用","aboutTitle":"关于","unknownHostVersion":"未知","versionMismatchHead":"⚠ 版本不一致","versionMismatchDetail":"Host 与浏览器端协议不兼容，请重启 DeepSeek Harness 加载最新 Host 端","versionBanner":"⚠ 系统监控组件版本不一致 · Browser v{browser} · Host {host} · 请重启 DeepSeek Harness","diagTitle":"DSH Side Monitor 诊断信息","diagHost":"主机：","diagRuntime":"运行环境：","diagSystemSource":"系统数据来源：","diagProcessSource":"进程数据来源：","diagDockerSource":"Docker 数据来源：","diagCpu":"CPU：","diagMemory":"内存：","diagLoad":"负载：","diagDisk":"磁盘：","diagUsage":"使用率：","diagCores":"核心：","copiedDiagnostics":"已复制诊断信息","diagDocker":"Docker：","diagTopProcesses":"主要进程：","systemData":"系统数据","processData":"进程数据","dockerData":"Docker 数据"},"en-US":{"monitorTitle":"System Monitor","live":"Live","refreshNow":"Refresh Now","more":"More","close":"Close","dragResize":"Drag to resize","clickViewSources":"Click to view data sources","refreshFailed":"Refresh failed · Last successful update {ago}","waitingFirstData":"Waiting for first data…","sampling":"Sampling…","dataInterrupted":"Data interrupted · Last successful update {ago}","viewSuffix":"view","copyDiagnostics":"Copy Diagnostics","viewDataSources":"Data Sources","about":"About","language":"Language","settingsV03":"Settings (v0.3)","settingsInV03":"Settings available in v0.3","loading":"Loading…","cannotFetch":"Failed to fetch data: ","unknownError":"Unknown error","updatedJustNow":"Updated just now","secondsAgo":"{sec} seconds ago","minutesAgo":"{n} min ago","hoursAgo":"{n} hr ago","connectionUnavailable":"Connection service unavailable","overview":"Overview","processes":"Processes","docker":"Docker","cpuUsage":"CPU Usage","memoryUsage":"Memory Usage","network":"Network","download":"Download","upload":"Upload","disk":"Disk","noDiskInfo":"No disk info available","systemLoad":"System Load","uptime":"Uptime","systemInfo":"System Information","operatingSystem":"Operating System","kernel":"Kernel","hostname":"Hostname","physicalCores":"Physical Cores","logicalCpu":"Logical CPUs","architecture":"Architecture","totalMemory":"Total Memory","diskPartitions":"Disk Partitions","networkInterfaces":"Network Interfaces","dockerContainers":"Docker Containers","total":"Total","running":"Running","issues":"Issues","all":"All","primary":"Main","virtual":"Virtual","iface":"Interface","receive":"Received","send":"Sent","coresThreadsLoad":"{phys} cores / {logical} threads · Load {load}","logicalCpuLoad":"{logical} logical CPUs · Load {load}","uptimeFull":"{d}d {hh}h {mm}m","uptimeHm":"{hh}h {mm}m","uptimeMs":"{mm}m {ss}s","uptimeS":"{s}s","dataSourceHost":"Host Data","dataSourceContainer":"Container Data","runtimeContainer":"DSH Container","runtimeHost":"DSH on host","dockerUnavailable":"Docker unavailable","dockerUnavailableSock":"Docker unavailable (no /var/run/docker.sock)","dockerSockMissing":"no /var/run/docker.sock","sourcePrefix":"Source: ","host":"Host","currentContainer":"Current Container","unknown":"Unknown","searchProcess":"Search process / command / user…","mem":"Memory","name":"Name","list":"List","grouped":"Grouped","processesTotal":"{total} processes","matchedSuffix":" · {matched} matched","matchedCount":"{matched} matched","groupsTotalMatched":"{total} groups · {matched} matched","byAggregatedCpu":"Sorted by aggregated CPU","loadMore":"Load More","process":"Process","user":"User","command":"Command","commandPrefix":"Command: ","uptimeLabel":"Uptime","groupsCount":"{count} processes","searchContainer":"Search containers / images / ports…","container":"Container","status":"Status","memory":"Memory","ports":"Ports","noPortMappings":"No port mappings","hostOnly":"Host only","notPublished":"Not published","containerOnly":"Container only","copiedAddr":"Address copied","copyFailed":"Copy failed","notPublishedToast":"Not published to host — container only","hostLocalToast":"Host-local only","titleUnpublished":"Not published to host (container-only port) — cannot open","titleHostLocal":"Host-local ({host}:{port}) — browser cannot open from outside","tooltipPort":"Host {host}:{port} · Container port {cport}/{proto}","showingContainers":"Showing {count} containers","httpOpen":"Open HTTP","httpsOpen":"Open HTTPS","copyAddress":"Copy address","copyAddressHostLocal":"Copy address (host-local)","runningState":"Running","pausedState":"Paused","stoppedState":"Stopped","healthy":"Healthy","unhealthy":"Unhealthy","starting":"Starting","upFor":"Up for {n} {unit}","unitSeconds":"seconds","unitMinutes":"minutes","unitHours":"hours","unitDays":"days","exitedState":"Exited","createdState":"Created","restartingState":"Restarting","dataSources":"Data Sources","runtime":"Runtime","loadUptime":"Load / Uptime","cpuCoresModel":"CPU cores / model","kernelVersion":"Kernel version","consistencyCheck":"⚠ Consistency check","unavailable":"Unavailable","aboutTitle":"About","unknownHostVersion":"unknown","versionMismatchHead":"⚠ Version mismatch","versionMismatchDetail":"Host and browser protocols are incompatible. Restart DeepSeek Harness to load the latest Host.","versionBanner":"⚠ System Monitor component versions do not match. Browser v{browser} · Host {host} · Restart DeepSeek Harness.","diagTitle":"DSH Side Monitor Diagnostics","diagHost":"Host:","diagRuntime":"Runtime:","diagSystemSource":"System data source:","diagProcessSource":"Process data source:","diagDockerSource":"Docker data source:","diagCpu":"CPU:","diagMemory":"Memory:","diagLoad":"Load:","diagDisk":"Disk:","diagUsage":"Usage:","diagCores":"Cores:","copiedDiagnostics":"Diagnostics copied","diagDocker":"Docker:","diagTopProcesses":"Top Processes:","systemData":"System Data","processData":"Process Data","dockerData":"Docker Data"}};
        var langListeners = [];
    ...
    function containerStateLabel(state) {
      if (state === "running") return t("runningState");
      if (state === "paused") return t("pausedState");
      if (state === "exited" || state === "dead") return t("stoppedState");
    ...
    function containerStatusBadge(c) {
      ...
      return { label: t("stoppedState"), color: COLORS.err };
    }
    ...
    //  - 0.0.0.0 / :: (any) and empty resolve to the address the DSH GUI was
    //    reached on (window.location.hostname);
    ...
    function portHost(p) {
      ...
      if (ip) {
        if (ip.indexOf(":") >= 0) {
          if (ip === "::" || ip === "0:0:0:0:0:0:0:0") return window.location.hostname || "localhost";
          if (ip === "::1" || ip === "0:0:0:0:0:0:0:1") return "[::1]";
          return "[" + ip + "]";
        }
        if (ip === "0.0.0.0") return window.location.hostname || "localhost";
    ...
    function formatContainerStatus(status) {
      ...
      if (/^Exited/.test(s)) return t("exitedState") + s.slice(6);
    ...
    var CSS = [
      ...
      ".dsm-menu-label{display:flex;align-items:center;gap:8px;width:100%;padding:6px 10px 2px;font-size:11px;color:var(--dsw-alias-label-secondary,#9aa3b2)}",
      // status line
      ...
      ".dsm-modal{background:var(--dsw-specific-surface-fill,#26262f);border:1px solid var(--dsw-alias-border-l2,rgba(255,255,255,.12));border-radius:12px;padding:16px;width:100%;max-width:440px;box-shadow:0 24px 64px rgba(0,0,0,.6)}",
    ...
    function ErrorBox(msg) { return h("div", { className: "dsm-state dsm-error" }, t("cannotFetch") + (msg || t("unknownError"))); }

    function StaleBanner(props) {
      return h("div", { className: "dsm-stale" },
        t("refreshFailed", { ago: props.ago }) + (props.msg ? " · " + props.msg : "")
      );
    }
    ...
    function NetKpi(overview) {
      ...
      return h("div", { className: "dsm-kpi" },
        h("div", { className: "dsm-kpi-head" }, t("network") + " · " + (primary ? primary.name : "—")),
    ...
    function DiskKpi(overview) {
      ...
      return h("div", { className: "dsm-kpi" },
        h("div", { className: "dsm-kpi-head" }, t("disk") + " · " + mount),
    ...
    function LoadSection(overview) {
      ...
      return h("div", { className: "dsm-section" },
        ...
        h("div", { className: "dsm-muted dsm-sub", style: { marginTop: 8 } }, t("uptime") + " " + fmtUptime(overview.uptimeSeconds))
      );
    }
    ...
    function DockerSummarySection(containers) {
      ...
      return h("div", { className: "dsm-section" },
        ...
        h("div", { className: "dsm-chips" },
          ...
          Chip(t("issues"), abnormal, abnormal > 0 ? COLORS.err : COLORS.ok)
        )
      );
    }
    ...
    function OverviewPanel(props) {
      ...
      var cpuSub = (phys != null && phys !== overview.cpuCores)
        ? t("coresThreadsLoad", { phys: phys, logical: overview.cpuCores, load: overview.load1.toFixed(2) })
        : t("logicalCpuLoad", { logical: overview.cpuCores, load: overview.load1.toFixed(2) });
      return h("div", { className: "dsm-panel" },
        ...
        h("div", { className: "dsm-metrics-grid" },
          ...
          MetricCard({ label: t("memoryUsage"), value: overview.memoryUsage, suffix: "%", color: COLORS.mem, history: props.memHistory, sub: fmtBytes(overview.memoryUsed) + " / " + fmtBytes(overview.memoryTotal) }),
          NetKpi(overview),
          DiskKpi(overview)
        ),
    ...
    function ProcessGroupCard(props) {
      ...
      return h("div", { className: "dsm-group-card", onClick: function () { setOpen(!open); } },
        ...
        open ? h("div", { className: "dsm-group-pids" },
    ...
    function ProcessesPanel(props) {
      ...
      var countText = isGroup
        ...
        : (t("processesTotal", { total: data.total }) + (query ? t("matchedSuffix", { matched: data.matched }) : ""));

      return h("div", { className: "dsm-panel" },
        stale ? StaleBanner(stale) : null,
        h("div", { className: "dsm-count", style: { display: "flex", justifyContent: "space-between", alignItems: "center" } },
          h("span", { className: "dsm-muted" }, t("sourcePrefix") + sourceText),
    ...
    function DockerPanel(props) {
      ...
      if (!data.available) {
        return h("div", { className: "dsm-panel" },
          h("div", { className: "dsm-state dsm-error", title: data.error || "" }, t("dockerUnavailable") + " · " + (data.error || t("dockerSockMissing")))
        );
      }
      ...
      var filters = [
        ...
        ["abnormal", t("issues"), abnormalCount],
      ];

      function openPort(p, protocol) {
        if (!isPublishedPort(p) || isLoopbackPort(p)) return; // never open
        window.open(protocol + "://" + portHost(p) + ":" + p.hostPort, "_blank");
      }

      function copyPort(p) {
        if (!isPublishedPort(p)) return;
        copyText(portHost(p) + ":" + p.hostPort, function (ok) { showToast(ok ? t("copiedAddr") : t("copyFailed")); });
      }
      ...
      function portChips(c) {
        ...
        return h("div", { className: "dsm-port-chips" },
          ports.map(function (item, i) {
            ...
            // loopback — yellow lock chip with "仅宿主机" tag
            if (isLoopbackPort(p)) {
              return h("span", {
                key: "l" + i,
                className: "dsm-port-chip dsm-port-chip-locked dsm-port-chip-loop",
                title: t("titleHostLocal", { host: portHost(p), port: p.hostPort }),
              },
                h("span", { className: "dsm-port-ico" }, "🔒"),
                String(p.hostPort),
            ...
            var tooltip = t("tooltipPort", { host: portHost(p), port: p.hostPort, cport: p.containerPort, proto: p.protocol || "tcp" });
            return h("button", {
              key: String(i) + label,
      ...
      return h("div", { className: "dsm-panel" },
        ...
        h("div", { className: "dsm-chips" },
          Chip(t("total"), s.total, "#8b8fa3"),
          Chip(t("running"), s.running, COLORS.ok),
          Chip(t("issues"), abnormalCount, abnormalCount > 0 ? COLORS.err : COLORS.ok)
        ),
        h("input", {
    ...
    function SourceModal(props) {
      ...
      var hostOr = env.systemSource === "host" ? t("host") : t("currentContainer");
      var procOr = env.processSource === "host" ? t("host") : t("currentContainer");
      var modeLabel = env.mode === "container" ? "Container" : env.mode === "host" ? "Host" : "—";
      var dockerLabel = env.dockerSource === "host"
        ? t("host") + " · " + (sources.dockerSocket || "/var/run/docker.sock")
      ...
      return h("div", { className: "dsm-modal-backdrop", onClick: props.onClose },
        h("div", { className: "dsm-modal", onClick: function (e) { e.stopPropagation(); } },
          ...
          h("div", { className: "dsm-kv" },
            ...
            row(t("loadUptime"), hostOr + " · " + sources.loadavg + " / " + sources.uptime),
            row(t("cpuCoresModel"), hostOr + " · " + sources.cpuinfo),
            row(t("kernelVersion"), hostOr + " · " + sources.osrelease),
            row(t("operatingSystem"), hostOr + " · " + sources.osRelease),
            row(t("networkInterfaces"), hostOr + " · " + sources.netDev + " + " + sources.fibTrie),
            row(t("disk"), hostOr + " · " + sources.mounts + " + " + sources.mountinfo),
            row(t("processes"), procOr + " · " + sources.processes),
    ...
    function AboutModal(props) {
      ...
      var env = props.env || {};
      var sysSrc = env.systemSource === "host" ? t("host") : env.systemSource === "container" ? t("currentContainer") : "—";
      var procSrc = env.processSource === "host" ? t("host") : env.processSource === "container" ? t("currentContainer") : "—";
      ...
      return h("div", { className: "dsm-modal-backdrop", onClick: props.onClose },
        h("div", { className: "dsm-modal", onClick: function (e) { e.stopPropagation(); } },
          ...
          h("div", { className: "dsm-kv" },
            ...
            row(t("runtime"), env.mode === "container" ? "Container" : env.mode === "host" ? "Host" : "—"),
    ...
    function buildDiagnostic(overview, processes, containers) {
      ...
      L.push(t("diagTitle"));
      L.push("");
      L.push(t("diagHost") + " " + (env ? env.hostname : "—"));
      L.push(t("diagRuntime") + " " + (env && env.mode === "container" ? "Container" : "Host"));
      L.push(t("diagSystemSource") + " " + (env ? sourceLabel(env.systemSource) : "—"));
      L.push(t("diagProcessSource") + " " + (env ? sourceLabel(env.processSource) : "—"));
      L.push(t("diagDockerSource") + " " + (env && env.dockerSource === "host" ? t("host") : env && env.dockerSource === "unavailable" ? t("unavailable") : "—"));
      if (overview) {
        L.push("");
        L.push(t("diagCpu"));
        L.push(overview.cpuModel);
        L.push(t("diagUsage") + " " + overview.cpuUsage.toFixed(1) + "%");
        L.push(t("diagCores") + " " + overview.cpuCores);
        L.push("");
        L.push(t("diagMemory"));
      ...
      if (containers && containers.available) {
        L.push(t("diagDocker"));
        L.push(t("total") + ": " + containers.summary.total);
        L.push(t("running") + ": " + containers.summary.running);
        L.push(t("unhealthy") + ": " + (containers.summary.unhealthy || 0));
      } else {
        L.push(t("diagDocker") + " " + t("unavailable"));
      }
    ...
    function MonitorDrawerBody(props) {
      ...
      // RPC version handshake: new client + old host (or protocol drift) must
      // surface as an explicit warning instead of cryptic undefined fields.
      function trackVersion(res) {
        if (!res) return res;
        if (res.pluginVersion) setHostVersion(String(res.pluginVersion));
        if (res.protocolVersion !== PROTOCOL_VERSION) setVersionMismatch(true);
        return res;
      }

      usePoll(function () {
        return callRpc(connection, "overview", {}).then(function (res) {
          res = trackVersion(res);
          if (res && res.ok) {
      ...
      usePoll(function () {
        return callRpc(connection, "processes", { query: procQueryD, sort: procSort, order: procOrder, offset: 0, limit: procLimit, aggregate: procView === "group" }).then(function (res) {
          res = trackVersion(res);
      ...
      }, 3000, tab === "processes", [procQueryD, procSort, procOrder, procLimit, procView, refreshVersion]);
      ...
      function statusInfo() {
        ...
        var src = env ? (tab === "docker" ? env.dockerSource : tab === "processes" ? env.processSource : env.systemSource) : null;
        var source = src ? " · " + (src === "unavailable" ? t("unavailable") : sourceLabel(src) + t("viewSuffix")) : "";
        if (!updatedAt) return { color: "#9aa3b2", text: t("waitingFirstData") };
        var sec = Math.max(0, Math.round((now - updatedAt) / 1000));
        if (error) return { color: COLORS.err, text: t("dataInterrupted", { ago: relTime(sec) }) + source };
        return { color: COLORS.ok, text: t("live") + " · " + relTime(sec) + source };
      }
      ...
      var modeLabel = dataSource === "host" ? t("dataSourceHost") : dataSource === "container" ? t("dataSourceContainer") : "…";
      var modeColor = dataSource === "host" ? COLORS.ok : COLORS.warn;
      var runtimeNote = mode === "container" ? t("runtimeContainer") : mode === "host" ? t("runtimeHost") : "";
      ...
      return h("div", { className: "dsm-root" + (isMobile ? " dsm-root-mobile" : ""), style: isMobile ? { width: "100%" } : { width: width + "px" } },
        ...
        h("div", { className: "dsm-header" },
          h("div", { className: "dsm-title-col" },
            ...
            h("span", { className: "dsm-hostname", title: env ? env.hostname : "" }, (env ? env.hostname : "") + (runtimeNote ? " · " + runtimeNote : ""))
          ),
        ...
        aboutModal ? h(AboutModal, { env: env, hostVersion: hostVersion, mismatch: versionMismatch, onClose: function () { setAboutModal(false); } }) : null
      );
    }
